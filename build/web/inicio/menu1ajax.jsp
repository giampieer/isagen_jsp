...
%>
<% 
obj=(PersonalBean)request.getAttribute("cargar");
%>
<!DOCTYPE html>
<html lang="en" >
<head>
...
<title>Gestion de Proyectos Personal</title>

</head>

<body id="page-top" class="index " onload="ingresarmenu('<%= obj.getID()%>')" >
<div id="wrapper">
<div class="overlay" >
<nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
<ul class="nav sidebar-nav">
<li class="sidebar-brand">
<a class="navbar-brand" href="javascript:cargar('<%=request.getContextPath()%>','Jefe',12)"  >PERSONAL</a>
</li>
<li class="dropdown">
<a class="dropdown-toggle" data-toggle="dropdown" href="#"  > BIENVENIDO: <%= obj.getID()%>  </a>          
<ul class="dropdown-menu" role="menu">
<li class="dropdown-header">Seleccione</li>
<li><a  id="menu"href="javascript:cargar('<%=request.getContextPath()%>','Personal',10,'cod='+ <%=obj.getCODPERSONAL()%>   )">Actualizar Datos Personales</a></li>
<li><a id="menu" href="javascript:cargar('<%=request.getContextPath()%>','Personal',14,'cod='+  <%=obj.getCODPERSONAL()%>     )">Cambiar  Password</a></li>
</ul>
</li>
<li class="dropdown">
<a class="dropdown-toggle" data-toggle="dropdown" href="#">INFORMACION</a>
<ul class="dropdown-menu" role="menu">
<li class="dropdown-header">Seleccione</li>
<li><a  href="javascript:cargar('<%=request.getContextPath()%>','Personal',16,'cod='+ <%=obj.getNUMPROY()%>   )">Informacion General</a></li>
</ul>
</li>
<li class="dropdown">
...
<ul class="dropdown-menu" role="menu">
<li class="dropdown-header">Seleccione</li>
<li><a  id="menu"  href="javascript:cargar('<%=request.getContextPath()%>','Reuniones',8,'cod='+ <%=obj.getNUMPROY()%>   )">Reuniones</a></li>
<li><a id="menu" href="javascript:cargar('<%=request.getContextPath()%>','Cambios',8,'cod='+ <%=obj.getNUMPROY()%>   )">Cambios</a></li>
<li><a  id="menu" href="javascript:cargar('<%=request.getContextPath()%>','Interesados',8,'cod='+ <%=obj.getNUMPROY()%>   )">Interesados</a></li>
<li><a  id="menu" href="javascript:cargar('<%=request.getContextPath()%>','Riesgos',8,'cod='+ <%=obj.getNUMPROY()%>   )">Riesgos</a></li>    
</ul>
</li>
<li class="dropdown">
...
<ul class="dropdown-menu" role="menu">
<li class="dropdown-header">Seleccione</li>
<li><a id="menu" href="javascript:cargar('<%=request.getContextPath()%>','Actividades',8,'cod='+<%=obj.getNUMPROY()%>)">Actividades</a></li>
<li><a  id="menu" href="javascript:cargar('<%=request.getContextPath()%>','ControldeCalidad',8,'cod='+<%=obj.getNUMPROY()%>)">Control de Calidad</a></li>
</ul>
</li>
<li class="dropdown">
...
<div class="row">
<div class="col-lg-12">
<img class="img-responsive" src="<%=request.getContextPath()%>/imagenes/profile.png" alt="">
