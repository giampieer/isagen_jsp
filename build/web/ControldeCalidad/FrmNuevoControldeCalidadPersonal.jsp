...
<%!   
ControldeCalidadDAO obj1=new ControldeCalidadDAO();
%>
<html>
<head>
    ...
    <center>
        <div class="row">
            <div class="form-group col-xs-12">
                <input type="button"  onclick="grabarControlPersonal('<%=request.getContextPath()%>')"value="grabar" class="btn btn-success btn-lg">
            </div>
            
        </div>
        <div class="row">
            <div class="form-group col-xs-12">
                <input type="button"  onclick="cargar('<%=request.getContextPath()%>','ControldeCalidad',8,'cod='+<%=objbean.getNUMPROY()%>)"value="salir" class="btn btn-success btn-lg">
            </div>
