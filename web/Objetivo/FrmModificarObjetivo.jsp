...
%>
<%!
ObjetivoBean objCubBean=null;
%>
<%
objCubBean=(ObjetivoBean)request.getAttribute("DATOS");
%>
<html>
<head>
    ...
    <div class="container animated zoomIn" style="max-width: 500px;width: 100%;background-color: white;border-radius: 7px">
        ...
        <div class="row">
            ...
            <div class="row control-group">
                <div class="form-group col-xs-12 floating-label-form-group controls">
                    ...
                    <input type="text" class="form-control"  name="txtdes" placeholder="Descripcion" value="<%=objCubBean.getDescripcion()%>">
        ...
        <div class="row control-group">
            <div class="form-group col-xs-12 floating-label-form-group controls">
                ...
                <input type="text" class="form-control"  name="txtfin" placeholder="Finalidad" value="<%=objCubBean.getFinalidad()%>">
                <p class="help-block text-danger"></p>
            </div>
        </div>
        ...
        <center>
            <div class="row">
                <div class="form-group col-xs-12">
                    <input type="button"onclick="modificarObjetivo('<%=request.getContextPath()%>')"value="modificar" class="btn btn-success btn-lg">
                </div>
                
            </div>
            <div class="row">
                <div class="form-group col-xs-12">
                    <input type="button"  onclick="salir('<%=request.getContextPath()%>','Objetivo',4)" value="salir" class="btn btn-success btn-lg">
                </div>
