...
<body onload="enfocar()">
    ...
    <div class="row control-group">
        <div class="form-group col-xs-12 floating-label-form-group controls">
            ...
            <input type="text" class="form-control"  name="txtfin" placeholder="Finalidad">
            <p class="help-block text-danger"></p>
        </div>
    </div>
    ...
    <center>
        <div class="row">
            <div class="form-group col-xs-12">
                <input type="button"onclick="grabarObjetivo('<%=request.getContextPath()%>')"value="grabar" class="btn btn-success btn-lg">
            </div>
