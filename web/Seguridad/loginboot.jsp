 ...
 <script>
  ...
  function enter(){
    ...
    if(usuario==''){
      ...
      document.form.action="<%=request.getContextPath()%>/JefeServlet?op=9";
  ...
  function SALIR(){
    ...
    document.form.action="<%=request.getContextPath()%>/JefeServlet?op=15";
    document.form.method="POST";
    document.form.submit();
  }
...
<body  style="background-color: #333333" onload="enfocar()">
 ...
 <h2 class="animated bounceInLeft"><center>LOGIN JEFE</center></h2>
 ...
 <center>
  ...
  <div id="login-form" class="animated zoomIn">
    ...
    <fieldset>
      ...
      <form    name="form">
        <img    class="animated infinite pulse"width="150px"src="<%=request.getContextPath()%>/imagenes/admin2.png">
